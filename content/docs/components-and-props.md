...
---
Компонентите ви дават възможност да разделите вашия потребителски интерефейс на независими, многократно използваеми части и да мислите за всяка от тях в изолация.
...
Може също да използвате класове [ES6 класове](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Classes) зада дефинирате компонент:
...
Той компонент приема `author` (като обект), `text` (низ), и `date` (дата) като props и описва коментар в уебсайт на социална медия.
