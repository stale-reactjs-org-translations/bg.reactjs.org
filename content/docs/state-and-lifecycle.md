...
1. Създаване на [ES6 class](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Classes), със същото име, което наследява `React.Component`.
...
В горния пример използваме [arrow function](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Functions/Arrow_functions), но също така може да бъде използвана и обикновенна такава:
